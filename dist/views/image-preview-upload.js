...
var _dropZone = require('./drop-zone.js');
...
var ImagePreviewUpload = function (_React$Component) {
    _inherits(ImagePreviewUpload, _React$Component);

    function ImagePreviewUpload(props) {
        _classCallCheck(this, ImagePreviewUpload);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ImagePreviewUpload).call(this, props));
    ...
    _createClass(ImagePreviewUpload, [{
...
ImagePreviewUpload.defaultProps = {
    scale: 0.5
};
exports.default = ImagePreviewUpload;